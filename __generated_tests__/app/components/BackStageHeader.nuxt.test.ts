...
// 來源：BackStageHeader.vue
// 產生時間：2026-09-07T06:46:19.710Z
// ============================================
import { describe, it, expect } from 'vitest';
import { mount } from '@vue/test-utils';
import BackStageHeader from '../../../app/components/BackStageHeader.vue';
...
function mountComponent(overrideProps = {}) {
  return mount(BackStageHeader, {
    props: { ...defaultProps, ...overrideProps },
  });
}

describe('BackStageHeader.vue', () => {
  // ===== 基本掛載 =====
  it('應該能正常掛載', () => {
